# %%writefile C:\Users\hs\Desktop\AiBioX\text_app.py
...
st.markdown(
    """마크다운 사용 가능합니다 1: True """, unsafe_allow_html=True
)
...
st.markdown(
    " <abc> 마크다운 테스트1 : True", unsafe_allow_html=True
)

st.markdown(
    " <abc> 마크다운 테스트2: False", unsafe_allow_html=False
)

st.markdown("마크다운 사용 가능합니다 2: False", unsafe_allow_html=False)
